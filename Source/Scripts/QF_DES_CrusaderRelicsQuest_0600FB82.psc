...
DES_NorthwatchArmorStandMarker.Disable()
Stop()
;END CODE
EndFunction
;END FRAGMENT
...
DES_CrusaderRelics_QuestPointer.SetObjectiveDisplayed(2, false)
DES_CrusaderRelics_QuestPointer.SetObjectiveDisplayed(4, false)
if !GetStageDone(255)
     DES_CrusaderRelics_QuestPointer.SetObjectiveCompleted(3)
endif
...
ObjectReference Property DES_NorthwatchArmorStandMarker  Auto  
